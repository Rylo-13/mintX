...
const Home: React.FC = () => {
  ...
  return (
    <div
      className="w-screen h-screen flex items-center justify-center welcomeContent"
      style={{
        backgroundImage: "url('/distorted.svg')",
      }}
    >
      <div className="w-11/12 sm:w-3/4 md:w-2/3 lg:w-1/2 mx-auto text-center bg-black bg-opacity-75 mb-16 py-8 sm:py-12 md:py-16 px-8 sm:px-12 md:px-16 rounded-lg">
