...
const ImageUploader: React.FC = () => {
  ...
  // Mutation for generating AI images
  ...
  const mintNFTMutation = useMutation({
    ...
    onSuccess: (nftDetails) => {
      ...
      console.log("Transaction Hash:", nftDetails.transactionHash);
    },
    onError: (err, _variables, context) => {
      ...
      const currentStep = mintingSteps.find(
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              {isGeneratedTab && (
                <div>
                  {!generatedImageUrl && !generateImageMutation.isPending && (
            ...
            <ConnectButton.Custom>
              {({ openConnectModal }) => (
                <RippleButton
                  ...
                  onClick={!isConnected ? openConnectModal : handleMintNFT}
                  disabled={
                    isConnected &&
                    (isMinting ||
